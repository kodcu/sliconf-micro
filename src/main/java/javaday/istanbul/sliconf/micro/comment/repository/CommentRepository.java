...
public interface CommentRepository extends MongoRepository<Comment, String>, CrudRepository<Comment, String> {
    ...
    // Order By rate
    // eventId
    //@Query("#{#n1ql.selectEntity} WHERE #{#n1ql.listEvents} AND approved = $1 AND eventId = $2 ORDER BY rate DESC")
    List<Comment> findAllByApprovedAndEventIdOrderByRateDesc(String approved, String eventId);

    //@Query("#{#n1ql.selectEntity} WHERE #{#n1ql.listEvents} AND approved = $1 AND eventId = $2 AND sessionId = $3 ORDER BY rate DESC OFFSET $3 LIMIT $4")
    Page<Comment> findAllByApprovedAndEventIdOrderByRateDesc(String approve, String eventId, Pageable pageable);

    // eventId, sessionId
    //@Query("#{#n1ql.selectEntity} WHERE #{#n1ql.listEvents} AND approved = $1 AND eventId = $2 AND sessionId = $3 ORDER BY rate DESC")
    List<Comment> findAllByApprovedAndEventIdAndSessionIdOrderByRateDesc(String approved, String eventId, String sessionId);

    //@Query("#{#n1ql.selectEntity} WHERE #{#n1ql.listEvents} AND approved = $1 AND eventId = $2 AND sessionId = $3 ORDER BY rate DESC OFFSET $4 LIMIT $5")
    ...
    //@Query("#{#n1ql.selectEntity} WHERE #{#n1ql.listEvents} AND approved = $1 AND eventId = $2 AND sessionId = $3 AND userId = $4 ORDER BY rate DESC")
    ...
    //@Query("#{#n1ql.selectEntity} WHERE #{#n1ql.listEvents} AND approved = $1 AND eventId = $2 AND sessionId = $3 AND userId = $4 ORDER BY rate DESC OFFSET $5 LIMIT $6")
    ...
    //@Query("#{#n1ql.selectEntity} WHERE #{#n1ql.listEvents} AND approved = $1 AND eventId = $2 OFFSET $3 LIMIT $4")
    Page<Comment> findAllByApprovedAndEventId(String approve, String eventId, Pageable pageable);

    //@Query("#{#n1ql.selectEntity} WHERE #{#n1ql.listEvents} AND approved = $1 AND eventId = $2 AND sessionId = $3 OFFSET $4 LIMIT $5")
    Page<Comment> findAllByApprovedAndEventIdAndSessionId(String approve, String eventId, String sessionId, Pageable pageable);

    //@Query("#{#n1ql.selectEntity} WHERE #{#n1ql.listEvents} AND approved = $1 AND eventId = $2 AND sessionId = $3 AND userId = $4 OFFSET $5 LIMIT $6")
    ...
    @Query("#{#n1ql.selectEntity} WHERE #{#n1ql.listEvents} AND approved = $1 AND eventId = $2 ORDER BY time DESC LIMIT $3")
    List<Comment> findFirstByApprovedAndEventIdOrderByTimeDesc(String approve, String eventId, int count);

    @Query("#{#n1ql.selectEntity} WHERE #{#n1ql.listEvents} AND approved = $1 AND eventId = $2 AND sessionId = $3 ORDER BY time DESC LIMIT $4")
    ...
    @Query("#{#n1ql.selectEntity} WHERE #{#n1ql.listEvents} AND approved = $1 AND eventId = $2 AND sessionId = $3 AND userId = $4 ORDER BY time DESC LIMIT $5")
    ...
    @Query("#{#n1ql.selectEntity} WHERE #{#n1ql.listEvents} AND approved = $1 AND eventId = $2 ORDER BY time ASC LIMIT $3")
    List<Comment> findFirstByApprovedAndEventIdOrderByTimeAsc(String approve, String eventId, int count);

    @Query("#{#n1ql.selectEntity} WHERE #{#n1ql.listEvents} AND approved = $1 AND eventId = $2 AND sessionId = $3 ORDER BY time ASC LIMIT $4")
    ...
    @Query("#{#n1ql.selectEntity} WHERE #{#n1ql.listEvents} AND approved = $1 AND eventId = $2 AND sessionId = $3 AND userId = $4 ORDER BY time ASC LIMIT $5")
    ...
    // eventId
    @Query("#{#n1ql.selectEntity} WHERE #{#n1ql.listEvents} AND approved = $1 AND eventId = $2 ORDER BY time DESC")
    List<Comment> findAllByApprovedAndEventIdOrderByTimeDesc(String approve, String eventId);

    //@Query("#{#n1ql.selectEntity} WHERE #{#n1ql.listEvents} AND approved = $1 AND eventId = $2 ORDER BY time DESC OFFSET $3 LIMIT $4")
    Page<Comment> findAllByApprovedAndEventIdOrderByTimeDesc(String approve, String eventId, Pageable pageable);

    // eventId, sessionId
    @Query("#{#n1ql.selectEntity} WHERE #{#n1ql.listEvents} AND approved = $1 AND eventId = $2 AND sessionId = $3 ORDER BY time DESC")
    List<Comment> findAllByApprovedAndEventIdAndSessionIdOrderByTimeDesc(String approve, String eventId, String sessionId);

    //@Query("#{#n1ql.selectEntity} WHERE #{#n1ql.listEvents} AND approved = $1 AND eventId = $2 AND sessionId = $3 ORDER BY time DESC OFFSET $4 LIMIT $5")
    ...
    // eventId, sessionId, userId
    @Query("#{#n1ql.selectEntity} WHERE #{#n1ql.listEvents} AND approved = $1 AND eventId = $2 AND sessionId = $3 AND userId = $4 ORDER BY time DESC")
    ...
    //@Query("#{#n1ql.selectEntity} WHERE #{#n1ql.listEvents} AND approved = $1 AND eventId = $2 AND sessionId = $3 AND userId = $4 ORDER BY time DESC OFFSET $5 LIMIT $6")
    ...
    // eventId
    @Query("#{#n1ql.selectEntity} WHERE #{#n1ql.listEvents} AND approved = $1 AND eventId = $2 ORDER BY time ASC")
    List<Comment> findAllByApprovedAndEventIdOrderByTimeAsc(String approve, String eventId);

    //@Query("#{#n1ql.selectEntity} WHERE #{#n1ql.listEvents} AND approved = $1 AND eventId = $2 ORDER BY time ASC OFFSET $3 LIMIT $4")
    Page<Comment> findAllByApprovedAndEventIdOrderByTimeAsc(String approve, String eventId, Pageable pageable);

    // eventId, sessionId
    @Query("#{#n1ql.selectEntity} WHERE #{#n1ql.listEvents} AND approved = $1 AND eventId = $2 AND sessionId = $3 ORDER BY time ASC")
    List<Comment> findAllByApprovedAndEventIdAndSessionIdOrderByTimeAsc(String approve, String eventId, String sessionId);

    //@Query("#{#n1ql.selectEntity} WHERE #{#n1ql.listEvents} AND approved = $1 AND eventId = $2 AND sessionId = $3 ORDER BY time ASC OFFSET $4 LIMIT $5")
    ...
    //  eventId, sessionId, userId
    @Query("#{#n1ql.selectEntity} WHERE #{#n1ql.listEvents} AND approved = $1 AND eventId = $2 AND sessionId = $3 AND userId = $4 ORDER BY time ASC")
    ...
    //@Query("#{#n1ql.selectEntity} WHERE #{#n1ql.listEvents} AND approved = $1 AND eventId = $2 AND sessionId = $3 AND userId = $4 ORDER BY time ASC OFFSET $5 LIMIT $6")
    ...
    // MOST LIKED COMMENT
    //@Query("#{#n1ql.selectEntity} WHERE #{#n1ql.listEvents} AND approved = $1 AND eventId = $2 ORDER BY rate DESC LIMIT 1")
